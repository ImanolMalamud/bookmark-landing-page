  ...
  return (
    ...
    >
      ...
      <div className="mt-[0.1875rem] mb-[1.875rem] text-center">
        ...
        <p className="text-normal mt-[0.3125rem] tracking-[-0.07em] text-very-dark-blue/50">
          {description}
        </p>
      </div>
      ...
      <a
        href="#"
        className="w-full rounded-md border-[0.188rem] border-soft-blue bg-soft-blue py-[0.6558rem] px-[1.437rem] text-center text-[0.875rem] font-medium text-white  transition duration-300 hover:bg-white hover:text-soft-blue"
      >
